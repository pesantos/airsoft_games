...
export class SeletorComponent implements OnInit {
  ...
  jogos:any = [
    ...
    {titulo:'BOMA',link:'bomb', icone:'fa fa-bomb',explicacao:'Uma série de utilitários revolvendo em torno de explosivos, com cores, segredos mortais, segredos simples, reveladores e etc.'},
